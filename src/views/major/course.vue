<template>
  ...
  <div
    v-show="closeShow"
    class="submenu"
    style="height: 45px; min-height: 45px"
  >
    <el-button
    ...
    <el-button
      @click="deleteBaseCourse"
      style="float: right"
      class="deleteButton"
      link
      ><el-icon class="iconSize"><Delete /></el-icon
    ></el-button>
  </div>
  ...
  <el-drawer v-model="drawer" :direction="direction">
    ...
    <template #default
      ...
      >
        <el-button
          @click="this.drawertoggleSelection()"
          style="float: left"
          class="clearSelected"
          link
          >取消选择</el-button
        ...
        <div class="numSelectedTeacher">
          已选中 {{ drawernumSelected }} 节基础课程
        </div>
        <el-button
          @click="addBaseCourseInProgram"
          style="float: right"
          class="drawerdeleteButton"
          link
  ...
  methods: {
    ...
    confirmClick() {
      ElMessageBox.confirm(
        `Are you confirm to chose ${this.drawernumSelected} ?`
      )
        .then(() => {
          this.drawer = false;
        })
    ...
    getBaseCourse(pageSize, pageNum, majorId) {
      ...
      if (majorId) {
        ...
        return request({
          ...
          console.log("courseDetails2:", res);
          console.log(
            "department:",
            that.departmentId,
            "schoolId:",
