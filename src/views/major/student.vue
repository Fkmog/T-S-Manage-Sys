    ...
    <div v-show="closeShow" class="submenu">
      <el-row>
        <el-col :span="2" class="columnstyle">
          <el-button @click="toggleSelection()" class="clearSelected" link
            >取消选择</el-button
          >
        </el-col>
        ...
        <el-col :span="4" class="columnstyle">
          <el-button @click="deleteStudent()" class="submenudeleteButton" link
    ...
    <div layout="row" flex v-show="hasStudent" class="md-padding">
      ...
      <div class="pagination-container" flex>
        <el-row type="flex" justify="center" align="middle">
          <el-button
            v-show="showLoadmore && hasProgram && hasStudent"
